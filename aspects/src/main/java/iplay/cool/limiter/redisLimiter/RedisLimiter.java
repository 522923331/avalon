//package iplay.cool.limiter.redisLimiter;
//
...
//import iplay.cool.limiter.MerchantLimiter;
...
//        return String.format("merchant:limiter:key:%s", merchantNo);
//    }
//
//    /**
//     * 从数据库中读取限流配置
...
//        wrapper.eq(MerchantLimiter::getUsed, 1);
...
//        });
//
//        redisUtils.set("merchant:limiter:tx:cache", txLimitMap, 1000 * 24 * 60 * 60L);
//        redisUtils.set("merchant:limiter:query:cache", queryLimitMap, 1000 * 24 * 60 * 60L);
//    }
//}
